...
| P1 | Special commands | `[~]` | Reapply known improvements and Free Sprite conversion are covered. Metatype replacement needs persisted metatype-quality provenance before it can safely remove/reapply grants; critter creation and BP availability remain. |
