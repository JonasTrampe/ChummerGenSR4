...
| P2 | Clipboard/history | `[~]` | Immutable snapshots and typed XML copy/paste, now including root-element re-validation matching legacy's second independent check, exist; Avalonia host wiring (Copy/Paste across ~7-9 collection tabs: Gear/Commlink/OS, Cyberware, Bioware, Armor, Weapon, Vehicle, Lifestyle) remains. |
