...
| P1 | Special commands | `[~]` | Reapply known improvements and Free Sprite conversion are covered. Metatype replacement now safely migrates base identity/ranges and preserves purchased attribute increments; target bonus/quality reapplication, critter creation, and BP availability remain. |
