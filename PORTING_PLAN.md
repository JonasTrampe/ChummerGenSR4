...
| P1 | Special commands | `[~]` | Reapply known improvements and Free Sprite conversion are covered. Quality provenance is persisted for safe metatype replacement, whose transactional migration remains; critter creation and BP availability remain. |
