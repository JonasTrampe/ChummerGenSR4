...
| P1 | Special commands | `[~]` | Reapply known improvements, Free Sprite conversion, transactional metatype replacement, BP/availability configuration, and critter creation (Core: NewCharacterFactory.CreateCritterCharacter) are covered; the Avalonia "New Critter" picker UI (metatype list against critters.xml, Force input) remains. |
