...
namespace Chummer
{
	...
	public interface IRunnersPointApiClient
	{
		...
		Task<RunnersPointDocumentPage> ListDocumentsAsync(string strGameProfileId, string strCursor = null, int intPageSize = 25);
		...
		Task<RunnersPointRevisionStatus> PushRevisionAsync(string strDocumentId, byte[] bytContent, string strIfMatch, string strGameProfileId, string strFormat);
		...
		Task<RunnersPointDocument> UpdateDocumentMetadataAsync(string strDocumentId, string strIfMatch, string strDisplayName, string strDescription, string strImageUrl);
		Task<RunnersPointSharedDocumentPage> ListSharedDocumentsAsync(string strGameProfileId, string strCursor = null, int intPageSize = 25);
		Task<Tuple<RunnersPointSharedDocument, string>> GetSharedDocumentAsync(string strDocumentId);
		Task<RunnersPointRevisionStatus> PushSharedDocumentRevisionAsync(string strDocumentId, byte[] bytContent, string strIfMatch, string strGameProfileId, string strFormat);
		Task<RunnersPointSharedDocument> UpdateSharedDocumentMetadataAsync(string strDocumentId, string strIfMatch, string strDisplayName, string strDescription, string strImageUrl);
