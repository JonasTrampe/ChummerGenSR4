...
namespace Chummer
{
	...
	public class Grade
	{
		...
		public void Load(XmlNode objNode)
		{
			...
			_decEss = Convert.ToDecimal(objNode["ess"].InnerText, CultureInfo.GetCultureInfo("en-US"));
			_dblCost = Convert.ToDouble(objNode["cost"].InnerText, CultureInfo.GetCultureInfo("en-US"));
			_intAvail = Convert.ToInt32(objNode["avail"].InnerText, CultureInfo.GetCultureInfo("en-US"));
