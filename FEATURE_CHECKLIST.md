...
- [~] **Creation-mode BP/Karma budget tracker**: status bar plus a live sidebar budget card show
  ...
  Contacts/Enemies, Qualities, Spells, and Complex Forms now debit/refund their persisted
  creation pool; the remaining house-rule limits and creation mutations still need to consume it
  directly.
